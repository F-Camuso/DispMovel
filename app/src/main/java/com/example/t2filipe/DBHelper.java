...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String DB_NAME = "sfv.db";
    public static final int DB_VERSION = 1;
    public static final String USER_TABLE = "users";
    public static final String COLUMN_NAME = "name";
    public static final String COLUMN_USERNAME = "username";
    public static final String COLUMN_PASSWORD = "password";
    public static final String COLUMN_CONFIRMA = "cnfrmpassword";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(" CREATE TABLE " + USER_TABLE +
                ...
                COLUMN_PASSWORD + " TEXT, " + COLUMN_CONFIRMA + " TEXT " +")");    }
    ...
    public void addUser(String name, String username, String password, String cnfrmpassword) {
        ...
        values.put(COLUMN_CONFIRMA, cnfrmpassword);
